  ...
  features = {
    ...
    ssh = {
      ...
      authorizedKeys = [
        ...
        "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIKfd/IriiH2+nzOd9dLUApJAjjmtimc9b02kD+SMHjgh tan@codebox"
      ];
    };
    localsend = {
      package.enable = true;
    ...
    codingTools = {
      ...
      repoSync = {
        ...
        repositories = [
          ...
          {
            path = "/home/tan/REPOS/renkei/renkei-core";
            autoCheckpoint = false;
          }
          {
            path = "/home/tan/REPOS/renkei/renkei-provider-anilist";
            autoCheckpoint = false;
          }
          {
            path = "/home/tan/REPOS/renkei/renkei-provider-jellyfin";
            autoCheckpoint = false;
          }
          {
            path = "/home/tan/REPOS/renkei/renkei-provider-shoko";
            autoCheckpoint = false;
          }
          {
            path = "/home/tan/REPOS/renkei/renkei-provider-simkl";
            autoCheckpoint = false;
          }
          {
            path = "/home/tan/REPOS/renkei/renkei-provider-trakt";
            autoCheckpoint = false;
          }
        ];
      };
