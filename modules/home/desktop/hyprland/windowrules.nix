...
''
  ...
  hl.window_rule({
    ...
    match = {
      class = "(?i)^(org\\.wezfurlong\\.wezterm|wezterm|com\\.mitchellh\\.ghostty|ghostty|kitty|Alacritty|alacritty|foot|org\\.gnome\\.Console|kgx|app\\.devsuite\\.Ptyxis|org\\.gnome\\.Ptyxis|ptyxis|org\\.kde\\.konsole|konsole|org\\.gnome\\.Terminal|gnome-terminal|terminator|com\\.github\\.gnunn1\\.tilix|tilix|xterm|uxterm|thunar|org\\.xfce\\.Thunar|org\\.kde\\.dolphin|dolphin|org\\.gnome\\.Nautilus|nautilus|nemo|org\\.nemo\\.Nemo|pcmanfm|pcmanfm-qt|org\\.lxde\\.PCManFM|org\\.lxqt\\.pcmanfm-qt|org\\.kde\\.krusader|krusader|equibop|vesktop|dev\\.vencord\\.Vesktop|discord|com\\.discordapp\\.Discord|org\\.telegram\\.desktop|telegram-desktop|element|im\\.riot\\.Riot|comet|org\\.gnome\\.Fractal|fractal|codex-desktop|ChatGPT|code|code-url-handler|com\\.visualstudio\\.code|code-oss|codium|vscodium|cursor|zed|dev\\.zed\\.Zed|t3-code|T3 Code.*|windsurf|jetbrains-.*|android-studio|neovide|emacs|micro|Paseo|paseo|paseo-desktop|spotify|electron)$",
    },
